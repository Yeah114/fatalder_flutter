...
class FatalderServiceClient extends $grpc.Client {
  ...
  FatalderServiceClient(super.channel, {super.options, super.interceptors});

  /// 服务器配置管理
  $grpc.ResponseFuture<$0.ServerConfigList> listServerConfigs(
    $0.Empty request, {
  ...
  $grpc.ResponseFuture<$0.ServerConfig> createServerConfig(
    $0.ServerConfig request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseFuture<$0.Empty> deleteServerConfig(
    $0.DeleteServerConfigRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  /// 任务组管理
  $grpc.ResponseFuture<$0.TaskGroupList> listTaskGroups(
    $0.Empty request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseFuture<$0.TaskGroup> getTaskGroup(
    $0.GetTaskGroupRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$getTaskGroup, request, options: options);
  }

  $grpc.ResponseFuture<$0.TaskGroup> createTaskGroup(
    $0.CreateTaskGroupRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$createTaskGroup, request, options: options);
  }

  $grpc.ResponseFuture<$0.Empty> deleteTaskGroup(
    $0.DeleteTaskGroupRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$deleteTaskGroup, request, options: options);
  }

  $grpc.ResponseStream<$0.TaskProgress> executeTaskGroup(
    $0.ExecuteTaskGroupRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createStreamingCall(
        _$executeTaskGroup, $async.Stream.fromIterable([request]),
        options: options);
  }

  /// 构建任务
  $grpc.ResponseStream<$0.BuildProgress> startBuild(
    $0.StartBuildRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createStreamingCall(
        _$startBuild, $async.Stream.fromIterable([request]),
        options: options);
  }

  $grpc.ResponseFuture<$0.Empty> controlBuild(
    $0.BuildControlRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  /// 导出任务
  $grpc.ResponseStream<$0.ExportProgress> startExport(
    $0.StartExportRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createStreamingCall(
        _$startExport, $async.Stream.fromIterable([request]),
        options: options);
  }

  /// 配置管理
  $grpc.ResponseFuture<$0.FrameworkConfig> getFrameworkConfig(
    $0.Empty request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseFuture<$0.FrameworkConfig> updateFrameworkConfig(
    $0.FrameworkConfig request, {
    $grpc.CallOptions? options,
  }) {
  ...
  /// 用户中心
  $grpc.ResponseFuture<$0.ValidateAPIKeyResponse> validateAPIKey(
    $0.ValidateAPIKeyRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  /// 文件浏览
  $grpc.ResponseFuture<$0.FileList> listFiles(
  ...
  static final _$listServerConfigs =
      $grpc.ClientMethod<$0.Empty, $0.ServerConfigList>(
          '/fatalder.FatalderService/ListServerConfigs',
          ($0.Empty value) => value.writeToBuffer(),
          $0.ServerConfigList.fromBuffer);
  ...
  static final _$createServerConfig =
      $grpc.ClientMethod<$0.ServerConfig, $0.ServerConfig>(
  ...
  static final _$updateServerConfig =
      $grpc.ClientMethod<$0.ServerConfig, $0.ServerConfig>(
          ...
          ($0.ServerConfig value) => value.writeToBuffer(),
          $0.ServerConfig.fromBuffer);
  static final _$deleteServerConfig =
      $grpc.ClientMethod<$0.DeleteServerConfigRequest, $0.Empty>(
          '/fatalder.FatalderService/DeleteServerConfig',
          ($0.DeleteServerConfigRequest value) => value.writeToBuffer(),
          $0.Empty.fromBuffer);
  static final _$listTaskGroups =
      $grpc.ClientMethod<$0.Empty, $0.TaskGroupList>(
          '/fatalder.FatalderService/ListTaskGroups',
          ($0.Empty value) => value.writeToBuffer(),
          $0.TaskGroupList.fromBuffer);
  static final _$getTaskGroup =
      $grpc.ClientMethod<$0.GetTaskGroupRequest, $0.TaskGroup>(
          '/fatalder.FatalderService/GetTaskGroup',
          ($0.GetTaskGroupRequest value) => value.writeToBuffer(),
          $0.TaskGroup.fromBuffer);
  static final _$createTaskGroup =
      $grpc.ClientMethod<$0.CreateTaskGroupRequest, $0.TaskGroup>(
          '/fatalder.FatalderService/CreateTaskGroup',
          ($0.CreateTaskGroupRequest value) => value.writeToBuffer(),
          $0.TaskGroup.fromBuffer);
  static final _$deleteTaskGroup =
      $grpc.ClientMethod<$0.DeleteTaskGroupRequest, $0.Empty>(
          '/fatalder.FatalderService/DeleteTaskGroup',
          ($0.DeleteTaskGroupRequest value) => value.writeToBuffer(),
          $0.Empty.fromBuffer);
  static final _$executeTaskGroup =
      $grpc.ClientMethod<$0.ExecuteTaskGroupRequest, $0.TaskProgress>(
          '/fatalder.FatalderService/ExecuteTaskGroup',
          ($0.ExecuteTaskGroupRequest value) => value.writeToBuffer(),
          $0.TaskProgress.fromBuffer);
  static final _$startBuild =
      $grpc.ClientMethod<$0.StartBuildRequest, $0.BuildProgress>(
          '/fatalder.FatalderService/StartBuild',
          ($0.StartBuildRequest value) => value.writeToBuffer(),
          $0.BuildProgress.fromBuffer);
  static final _$controlBuild =
      $grpc.ClientMethod<$0.BuildControlRequest, $0.Empty>(
          '/fatalder.FatalderService/ControlBuild',
          ($0.BuildControlRequest value) => value.writeToBuffer(),
          $0.Empty.fromBuffer);
  static final _$startExport =
      $grpc.ClientMethod<$0.StartExportRequest, $0.ExportProgress>(
          '/fatalder.FatalderService/StartExport',
          ($0.StartExportRequest value) => value.writeToBuffer(),
          $0.ExportProgress.fromBuffer);
  static final _$getFrameworkConfig =
      $grpc.ClientMethod<$0.Empty, $0.FrameworkConfig>(
          '/fatalder.FatalderService/GetFrameworkConfig',
          ($0.Empty value) => value.writeToBuffer(),
          $0.FrameworkConfig.fromBuffer);
  static final _$updateFrameworkConfig =
      $grpc.ClientMethod<$0.FrameworkConfig, $0.FrameworkConfig>(
          '/fatalder.FatalderService/UpdateFrameworkConfig',
          ($0.FrameworkConfig value) => value.writeToBuffer(),
          $0.FrameworkConfig.fromBuffer);
  static final _$validateAPIKey =
      $grpc.ClientMethod<$0.ValidateAPIKeyRequest, $0.ValidateAPIKeyResponse>(
          '/fatalder.FatalderService/ValidateAPIKey',
          ($0.ValidateAPIKeyRequest value) => value.writeToBuffer(),
          $0.ValidateAPIKeyResponse.fromBuffer);
  static final _$listFiles =
      $grpc.ClientMethod<$0.ListFilesRequest, $0.FileList>(
          '/fatalder.FatalderService/ListFiles',
          ($0.ListFilesRequest value) => value.writeToBuffer(),
          $0.FileList.fromBuffer);
  static final _$streamLogs =
      $grpc.ClientMethod<$0.StreamLogsRequest, $0.LogMessage>(
          '/fatalder.FatalderService/StreamLogs',
...
abstract class FatalderServiceBase extends $grpc.Service {
  ...
  FatalderServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.DeleteServerConfigRequest, $0.Empty>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.DeleteServerConfigRequest.fromBuffer(value),
        ($0.Empty value) => value.writeToBuffer()));
    ...
    $addMethod($grpc.ServiceMethod<$0.GetTaskGroupRequest, $0.TaskGroup>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.GetTaskGroupRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.CreateTaskGroupRequest, $0.TaskGroup>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.CreateTaskGroupRequest.fromBuffer(value),
        ($0.TaskGroup value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.DeleteTaskGroupRequest, $0.Empty>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.DeleteTaskGroupRequest.fromBuffer(value),
        ($0.Empty value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.ExecuteTaskGroupRequest, $0.TaskProgress>(
        ...
        true,
        ($core.List<$core.int> value) =>
            $0.ExecuteTaskGroupRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.BuildControlRequest, $0.Empty>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.BuildControlRequest.fromBuffer(value),
        ($0.Empty value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.StartExportRequest, $0.ExportProgress>(
        ...
        true,
        ($core.List<$core.int> value) =>
            $0.StartExportRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.FrameworkConfig, $0.FrameworkConfig>(
        ...
        ($0.FrameworkConfig value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.ValidateAPIKeyRequest,
            $0.ValidateAPIKeyResponse>(
        'ValidateAPIKey',
        validateAPIKey_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.ValidateAPIKeyRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.StreamLogsRequest, $0.LogMessage>(
        'StreamLogs',
        streamLogs_Pre,
        false,
        true,
  ...
  $async.Future<$0.ServerConfigList> listServerConfigs_Pre(
      $grpc.ServiceCall $call, $async.Future<$0.Empty> $request) async {
    return listServerConfigs($call, await $request);
  }

  $async.Future<$0.ServerConfigList> listServerConfigs(
  ...
  $async.Future<$0.ServerConfig> createServerConfig_Pre(
      $grpc.ServiceCall $call, $async.Future<$0.ServerConfig> $request) async {
    return createServerConfig($call, await $request);
  }

  $async.Future<$0.ServerConfig> createServerConfig(
      $grpc.ServiceCall call, $0.ServerConfig request);

  $async.Future<$0.ServerConfig> updateServerConfig_Pre(
      $grpc.ServiceCall $call, $async.Future<$0.ServerConfig> $request) async {
  ...
  $async.Future<$0.Empty> deleteServerConfig_Pre($grpc.ServiceCall $call,
      $async.Future<$0.DeleteServerConfigRequest> $request) async {
    return deleteServerConfig($call, await $request);
  }

  $async.Future<$0.Empty> deleteServerConfig(
      $grpc.ServiceCall call, $0.DeleteServerConfigRequest request);

  $async.Future<$0.TaskGroupList> listTaskGroups_Pre(
      $grpc.ServiceCall $call, $async.Future<$0.Empty> $request) async {
    return listTaskGroups($call, await $request);
  }

  $async.Future<$0.TaskGroupList> listTaskGroups(
      $grpc.ServiceCall call, $0.Empty request);

  $async.Future<$0.TaskGroup> getTaskGroup_Pre($grpc.ServiceCall $call,
      $async.Future<$0.GetTaskGroupRequest> $request) async {
    return getTaskGroup($call, await $request);
  }

  $async.Future<$0.TaskGroup> getTaskGroup(
      $grpc.ServiceCall call, $0.GetTaskGroupRequest request);

  $async.Future<$0.TaskGroup> createTaskGroup_Pre($grpc.ServiceCall $call,
      $async.Future<$0.CreateTaskGroupRequest> $request) async {
    return createTaskGroup($call, await $request);
  }

  $async.Future<$0.TaskGroup> createTaskGroup(
      $grpc.ServiceCall call, $0.CreateTaskGroupRequest request);

  $async.Future<$0.Empty> deleteTaskGroup_Pre($grpc.ServiceCall $call,
      $async.Future<$0.DeleteTaskGroupRequest> $request) async {
    return deleteTaskGroup($call, await $request);
  }

  $async.Future<$0.Empty> deleteTaskGroup(
      $grpc.ServiceCall call, $0.DeleteTaskGroupRequest request);

  $async.Stream<$0.TaskProgress> executeTaskGroup_Pre($grpc.ServiceCall $call,
      $async.Future<$0.ExecuteTaskGroupRequest> $request) async* {
    yield* executeTaskGroup($call, await $request);
  }

  $async.Stream<$0.TaskProgress> executeTaskGroup(
      $grpc.ServiceCall call, $0.ExecuteTaskGroupRequest request);

  $async.Stream<$0.BuildProgress> startBuild_Pre($grpc.ServiceCall $call,
      $async.Future<$0.StartBuildRequest> $request) async* {
    yield* startBuild($call, await $request);
  }

  $async.Stream<$0.BuildProgress> startBuild(
      $grpc.ServiceCall call, $0.StartBuildRequest request);

  $async.Future<$0.Empty> controlBuild_Pre($grpc.ServiceCall $call,
      $async.Future<$0.BuildControlRequest> $request) async {
    return controlBuild($call, await $request);
  }

  $async.Future<$0.Empty> controlBuild(
      $grpc.ServiceCall call, $0.BuildControlRequest request);

  $async.Stream<$0.ExportProgress> startExport_Pre($grpc.ServiceCall $call,
      $async.Future<$0.StartExportRequest> $request) async* {
    yield* startExport($call, await $request);
  }

  $async.Stream<$0.ExportProgress> startExport(
      $grpc.ServiceCall call, $0.StartExportRequest request);

  $async.Future<$0.FrameworkConfig> getFrameworkConfig_Pre(
      $grpc.ServiceCall $call, $async.Future<$0.Empty> $request) async {
    return getFrameworkConfig($call, await $request);
  }

  $async.Future<$0.FrameworkConfig> getFrameworkConfig(
      $grpc.ServiceCall call, $0.Empty request);

  $async.Future<$0.FrameworkConfig> updateFrameworkConfig_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.FrameworkConfig> $request) async {
    return updateFrameworkConfig($call, await $request);
  }

  $async.Future<$0.FrameworkConfig> updateFrameworkConfig(
      $grpc.ServiceCall call, $0.FrameworkConfig request);

  $async.Future<$0.ValidateAPIKeyResponse> validateAPIKey_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.ValidateAPIKeyRequest> $request) async {
    return validateAPIKey($call, await $request);
  }

  $async.Future<$0.ValidateAPIKeyResponse> validateAPIKey(
      $grpc.ServiceCall call, $0.ValidateAPIKeyRequest request);

  $async.Future<$0.FileList> listFiles_Pre($grpc.ServiceCall $call,
      $async.Future<$0.ListFilesRequest> $request) async {
    return listFiles($call, await $request);
  }

  $async.Future<$0.FileList> listFiles(
      $grpc.ServiceCall call, $0.ListFilesRequest request);

  $async.Stream<$0.LogMessage> streamLogs_Pre($grpc.ServiceCall $call,
      $async.Future<$0.StreamLogsRequest> $request) async* {
    yield* streamLogs($call, await $request);
  }

  $async.Stream<$0.LogMessage> streamLogs(
      $grpc.ServiceCall call, $0.StreamLogsRequest request);
}
